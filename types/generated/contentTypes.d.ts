...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tools: Attribute.Relation<'api::blog.blog', 'manyToMany', 'api::tool.tool'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiNowNow extends Schema.CollectionType {
  collectionName: 'nows';
  info: {
    singularName: 'now';
    pluralName: 'nows';
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::now.now', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::now.now', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiStyleguideStyleguide extends Schema.CollectionType {
  ...
  attributes: {
    ...
    direct_reference: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::styleguide.styleguide',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiToolTool extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    blogs: Attribute.Relation<'api::tool.tool', 'manyToMany', 'api::blog.blog'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::styleguide.styleguide': ApiStyleguideStyleguide;
